                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left d-flex">
                                    ...
                                    <span id="welcome" sec:authentication="principal.username"></span>님 환영합니다.&nbsp;
                                ...
                                <div class="header-info-right">
                                   <ul>                                          
                                       ...
                                       <li><a sec:authorize="hasRole('ROLE_USER')" th:href="/estore/product/productInsert">Checkout</a></li>
                                       <li><a sec:authorize="hasRole('ROLE_MANAGER')" th:href="/estore/product/productInsert">Add Item</a></li>
