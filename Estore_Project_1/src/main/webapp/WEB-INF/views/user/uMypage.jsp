            ...
            <c:forEach items="${uMonthList }" var="list" varStatus="vs">  
              ...
              <tr>
                ...
                <td><!-- 리뷰 -->
                  ...
                  <%-- /${list.pnum }/${list.onum }/${sid } --%>
                  	<h5 onclick="javascript:insertFunction(${list.pnum },${list.onum },'${list.sid }')">작성하기</h5>
                  </c:if>
...
<script>
function insertFunction(pnum, onum, sid){
